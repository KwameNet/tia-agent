...
**Source:** SCL_help_instructions_s7_1200_1500.pdf, page 170  
...
and to write this to a single tag in the little endian byte sequence. With the little endian for-
mat, the byte with the least significant bits is saved first, which means at the lowest memo-
ry address.
...
floating-
point num-
DEST_VAR point num- I, Q, M, D,
Output bers, LDT, Read value
IABLE bers, TOD, L
TOD, LTOD,
DATE,
DATE,
...
16#4D3C2B1A
POS #TagPos 0 => 4
The instruction reads the integer 1_295_788_826 from the #SourceField memory area and
writes it to the #DINTVariable operand in little endian format. The data type at the
