...
**Source:** SCL_help_instructions_s7_1200_1500.pdf, page 119  
...
FILL_BLK: Fill block
Description
You can use the "Fill block" instruction to fill a memory area (target range) with the value of
the IN input. The target range is filled beginning with the address specified at the OUT out-
put. The number of repeated copy operations is specified with the COUNT parameter.
When the instruction is executed, the value at the input IN is moved to the target range as
often as specified by the value of the COUNT parameter.
...
bers, integers,
floating-point
floating-point Element used
numbers, I, Q, M, D,
IN Input numbers, to fill the target
timers, DATE, L, P
timers, TOD, range
CHAR,
DATE, CHAR,
...
Binary num-
Binary num-
bers, integers, Address in tar-
bers, integers,
floating-point get range from
OUT Output floating-point D, L
numbers, which filling
numbers,
timers, DATE, starts
timers, TOD,
CHAR,
...
three times, starting with the first element.
